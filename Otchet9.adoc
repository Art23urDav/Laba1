...
include::Title9.adoc[lines=1..8]

[.text-center]
Отчет по лабораторной работе №9 +
на тему "Таймеры"

include::Title9.adoc[lines=12..24]
...
video::https://www.veed.io/view/1d0b69f4-dfde-43e4-85c0-c302441d2afc?sharingWidget=true&panel=share[]
